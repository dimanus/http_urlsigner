...
class HTTP_UrlSigner
{
     ...
     * @var array
     */
    protected array $_safeBase64 = array(array('+', '/', "="), array('_', '~', '-'));
     ...
     * @var string
     */
    private ?string $_maskPrefixFull = null;
     ...
     * @var string
     */
    private ?string $_maskPrefix = null;
     ...
     * @var string
     */
    private ?string $_maskSuffix = null;

    /**
     * Create new HTTP_UrlSigner object.
     *
     * @param string $secret
     * @param string $baseUrl
     */
    public function __construct(string $secret, string $urlMask)
    {
        $this->_secret = $secret;
        $this->_mask = $urlMask;
    ...
    protected function _getUriByUrl($url): string
    {
        $m = null;
    ...
    protected function _splitUrl($url): array
    {
    ...
    protected function _hash($data): string
    {
    ...
    protected function _substr($s, $from, $len = null): string
    {
        if ($len !== null) {
